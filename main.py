...
Clean Minimal UI - Integrates CPU, Memory, Disk, File
"""
...
class MiniOSSimulator:
    ...
    def setup_gui(self):
        ...
        nav_items = [
            ...
            ("File Management", self.open_file),
        ]
    ...
    def show_welcome(self):
        ...
        modules = [
            ...
            ("Disk Scheduling", "FCFS, SSTF, SCAN, LOOK, C-SCAN", self.open_disk),
            ("File Management", "Create, Delete, View", self.open_file),
        ]
